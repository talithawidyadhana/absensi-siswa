		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.php" class="logo">
					<b class="text-white">SMK Texmaco Subang</b>
				</a>
						...
						<li class="nav-item">
							...
							<div class="collapse" id="sidebarLayouts">
								<ul class="nav nav-collapse">
									...
									<li>
										<a href="?page=absen&jadwal=<?=$dm['id_mengajar'] ?> ">
		...
		<footer class="footer">
				<div class="container">
					<div class="copyright ml-auto">
						&copy; <?php echo date('Y');?> Absensi Absensi Siswa SMK Texmaco Subang (<a href="index.php">PERDI SELVY REVI </a> | 2024)
					</div>				
				</div>
			</footer>
		</div>
